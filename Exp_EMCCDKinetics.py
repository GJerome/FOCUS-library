...
DarkTime = 5 # time of dark time in seconds
...
PositionCube=[20,20,100,100]# [x_start y_start x_length y_length] x = y and y = x
...
camera=EMCCD.LightFieldControl('KineticModeMarcel')
...
FreqSweep=np.array([4],dtype=np.dtype(int))#,8,16,80,160
...
PowerSweep=np.array([1000,1000,1500,1500,2000,2000,2500,2500,3000,3000,3500,3500,4000,4000],dtype=np.dtype(int)) #[2600,2600,2600,3200,3200,3200,4600,4600,4600,13100,13100,13100,17500,17500,17500]
